...
<body class="min-h-screen px-4 py-12 bg-gradient-to-br from-blue-50 to-indigo-100 sm:px-6 lg:px-8">
    <div class="max-w-3xl mx-auto">
        <!-- Card Container -->
        <div class="overflow-hidden transition-all duration-300 transform bg-white shadow-xl rounded-2xl hover:scale-102">
            <!-- Header -->
            ...
            <div class="p-8 space-y-6">
                <!-- Stage Name -->
                <div class="p-4 transition-transform duration-300 transform shadow-sm hover:scale-105 bg-gray-50 rounded-xl">
